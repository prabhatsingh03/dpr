...
def init_database():
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS daily_progress_reports (
            ...
            activity_description VARCHAR(500) NOT NULL,
            planned_today DECIMAL(10,2) DEFAULT 0,
            achieved_today DECIMAL(10,2) DEFAULT 0,
            planned_cumulative DECIMAL(10,2) DEFAULT 0,
            achieved_cumulative DECIMAL(10,2) DEFAULT 0,
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
